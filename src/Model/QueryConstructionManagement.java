...
import Model.IRIMapping.TripleNumberComparator;

import java.util.Collections;
import java.util.Comparator;

public class QueryConstructionManagement {
      ...
      System.out.println(" hello world ");
		 ...
		 for(ResourceInfo s:IRIList)
		 {
			  ...
			  if( s.getType() == Constants.TYPE_INSTANCE )
			 {
				 ...
				 /*for(String r:s.getClassSet())
				 {
					 classiri.addAll(CM.getSuperClasses(r)); 
				 }
				*/ 
			 ...
			 else if( s.getType() == Constants.TYPE_CLASS )
			 {
				...
				// classiri.addAll(CM.getSuperClasses(s.getUri()));
				 Graph g      =  new Graph();
